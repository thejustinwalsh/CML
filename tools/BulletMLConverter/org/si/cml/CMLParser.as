...
package org.si.cml {
    ...
    //------------------------------------------------------------
        ...
        static internal function userReference(name:String, func:Function) : void
        {
        ...
        static internal function userCommand(name:String, func:Function, argc:int, requireSequence:Boolean) : void
        {
    ...
    // parsing
    //------------------------------------------------------------
        static internal function _parse(seq:CMLSequence, cml_string:String) : void
        {
