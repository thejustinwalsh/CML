...
package org.si.cml {
    /** @private */
    internal class CMLBarrageElem extends CMLListElem
    {
        // Quartarnion
    ...
    //--------------------------------------------------
        // set sequencial step
        internal function setSequence(count_:int, angle_:Number, speed_:Number, interval_:Number) : CMLBarrageElem
        {
        ...
        // copy all parameters
        internal function copy(src:CMLBarrageElem) : CMLBarrageElem
        {
            count = src.count;
            angle = src.angle;
            speed = src.speed;
    ...
    //--------------------------------------------------
        // initialize
        private function _init(parent:CMLBarrageElem) : void
        {
            counter = count;
        ...
        // initialize random
        private function _init_random(parent:CMLBarrageElem) : void
        {
            counter = count;
