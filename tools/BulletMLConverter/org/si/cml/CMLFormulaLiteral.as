...
package org.si.cml {
    ...
    internal class CMLFormulaLiteral extends CMLFormulaElem
    {
        ...
        private function rankg(fbr:CMLFiber):Number { return CMLObject._globalRank[num]; }
        ...
        private function objh(fbr:CMLFiber): Number { return fbr.object.angleOnScreen; }
        ...
        private function prt_objh(fbr:CMLFiber): Number { return fbr.object.parent.angleOnScreen; }
        ...
        private function tgt_objh(fbr:CMLFiber): Number { return fbr.target.angleOnScreen; }
